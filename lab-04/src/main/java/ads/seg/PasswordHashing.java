...
public abstract class PasswordHashing {
    ...
    /**
        /* Metodo que recebe uma senha e a converte para um array de bytes
        /* @param passwprd de senha do usuário em formato char[]
    ...
    */
    ...
    /**
        /* Metodo que recebe uma senha, um salt e um algoritmo de hash e retorna o hash da senha
    ...
    */
    ...
    /**
        /* Metodo que verifica se a senha fornecida é igual ao hash da senha armazenado
        /* @param password senha do usuário
        /* @param salt salt aleatório
        /* @param algorithm algoritmo de hash
    ...
    /**
        /* Metodo que recebe uma senha, um salt, um algoritmo de hash, número de iterações e tamanho da chave e retorna o hash da senha
        /* @param password senha do usuário
        /* @param salt salt aleatório
        /* @param algorithm algoritmo de hash
    ...
    */
    public static byte[] hashPasswordWithPBKDF2(char[] password, byte[] salt, String algorithm, int iterations, int
            keyLength) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    */
    public static boolean verifyPasswordWithPBKDF2(char[] password, byte[] salt, String algorithm, int iterations, int
        ...
        return encoder.encodeToString(hashPasswordWithPBKDF2(password, salt, algorithm, iterations, keyLength)).equals(
                encoder.encodeToString(hashedPassword));
    }

    /**
        /* Metodo que recebe uma senha e retorna o hash da senha com BCrypt
        /*
    ...
    */
    ...
    /**
        /* Metodo que verifica se a senha fornecida é igual ao hash da senha armazenado com BCrypt
        /*
        /* Não é necessário fornecer um salt, pois o BCrypt já gera um salt aleatório internamente
        /* @param password senha do usuário
        /* @param hashedPassword hash da senha armazenado
